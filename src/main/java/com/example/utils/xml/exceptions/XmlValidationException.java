...
/**
 * A specialized exception thrown during XML schema validation.
 * It captures all validation errors, not just the first one,
 * allowing for user-friendly error reporting.
 */
@Getter
